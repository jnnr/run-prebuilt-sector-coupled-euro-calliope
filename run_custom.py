...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", "--input_model_nc", help="Path to built model inputs NetCDF file", type=str)
    parser.add_argument("-o", "--output_model_nc", help="Path to optimised model NetCDF file", type=str)
